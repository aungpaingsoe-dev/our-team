...
export default function ContactSection() {
  return (
    <section
      id="contact"
      className="section min-h-[500px] flex flex-col justify-between text-center"
    >
      <div className="text-center">
        <span>
          <h2 className="text-2xl inline-block font-bold">Contact</h2>
        </span>
      </div>
      <div className="mt-8 mb-12">
        ...
        <p className="mb-6 mx-auto max-w-lg md:mb-10 lg:leading-loose">
          Whether you have a question, an idea, or just want to say hello, we’re
          here to connect. Let’s collaborate and create something amazing
          together!
        </p>
      ...
      <footer className="pb-24 md:pb-4 text-center mt-auto">
